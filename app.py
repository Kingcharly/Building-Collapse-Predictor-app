...
def main():
    ...
    with col2:
        input_data['Y6_fyk'] = st.number_input("6mm Bar Yield Strength (MPa)", 0.0, 600.0, 415.0, 5.0)
        input_data['Y8_fyk'] = st.number_input("8mm Bar Yield Strength (MPa)", 0.0, 600.0, 415.0, 5.0)
        input_data['Y10_fyk'] = st.number_input("10mm Bar Yield Strength (MPa)", 0.0, 600.0, 415.0, 5.0)
        input_data['Y12_fyk'] = st.number_input("12mm Bar Yield Strength (MPa)", 0.0, 600.0, 415.0, 5.0)
        input_data['Y16_fyk'] = st.number_input("16mm Bar Yield Strength (MPa)", 0.0, 600.0, 415.0, 5.0)
        input_data['Y20_fyk'] = st.number_input("20mm Bar Yield Strength (MPa)", 0.0, 600.0, 415.0, 5.0)
        input_data['Y25_fyk'] = st.number_input("25mm Bar Yield Strength (MPa)", 0.0, 600.0, 415.0, 5.0)
