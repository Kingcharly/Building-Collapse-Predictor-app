                ...
                with st.spinner("Analyzing building factors..."):
                    ...
                    if explanation_obj is None:
                        ...
                        if is_collapse_prediction:
                            ...
                            risk_title = "🔴 Top 5 Factors Increasing Collapse Risk:"
                            safety_title = "🟢 Top 5 Factors Reducing Collapse Risk:"
                        else:
                            # For safe predictions, negative weights support safety, positive weights work against safety
                            safety_factors = [(f, w) for f, w in filtered_explanation if w < 0]
                            risk_factors = [(f, w) for f, w in filtered_explanation if w > 0]

                            risk_title = "🟡 Top 5 Factors Working Against Safety:"
                            safety_title = "🟢 Top 5 Factors Supporting Building Safety:"
                        ...
                        if risk_factors:
                            ...
                            # Optional message when there are no positive weights
                            if not is_collapse_prediction:
                                st.info("No significant risk factors detected. Building appears structurally sound.")
